            ...
            <table className="mt-5">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td className="total">${data?.itemsPrice}</td>
                </tr>
                ...
                <tr>
                  ...
                  <td className="total">${data?.taxAmount}</td>
                </tr>
                ...
                <tr>
                  ...
                  <td className="total">${data?.shippingAmount}</td>
                </tr>
                ...
                <tr>
                  ...
                  <td className="grand total">${data?.totalAmount}</td>
                </tr>
              </tbody>
            </table>
            <div id="notices">
